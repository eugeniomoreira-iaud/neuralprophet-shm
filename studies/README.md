...
| 4 | [`04_neuralprophet_inclination_prediction/`](04_neuralprophet_inclination_prediction/) | What is the compensated inclination record made of, is a newly arrived reading the one the measured environment predicts, how far ahead is forecasting worth anything, and what size of departure would a residual monitor actually catch? | Complete |
| 5 | [`05_greybox_monitoring/`](05_greybox_monitoring/) | What is the whole eight-year record made of, does the wall answer its drivers with a delay the 20-minute grid can resolve, is a newly arrived reading the one expected, what departure does each monitoring chart catch at a stated false-alarm budget, and what happened across each outage? | Design approved |
