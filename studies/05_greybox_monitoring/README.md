...
Status: **in progress — Phase 3 complete (record, clocks, regressor sets, harmonic diagnostics, Model A attribution on three sets, current-era ladder, rolling expectation with rolling conformal bounds).** Built to the design in
