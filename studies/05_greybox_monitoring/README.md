...
Status: **in progress — Phase 4 complete (record, clocks, regressor sets, harmonic diagnostics, Model A attribution on three sets, current-era ladder, rolling expectation with rolling conformal bounds, Model B impulse response).** Built to the design in
